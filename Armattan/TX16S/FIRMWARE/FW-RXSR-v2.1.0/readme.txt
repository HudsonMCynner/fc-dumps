...
This Package is for RXSR ACCST v2.1.0 firmware update. 
...
RXSR_ACCST_V2.1.0_Fport_FCC.frk                              Firmware under NonLbt mode which is certificated for FCC rules. F.Port protocol output supported.
RXSR_ACCST_V2.1.0_Fport_LBT.frk                               Firmware under LBT mode which is certificated for CE rules.  F.Port protocol output supported.
